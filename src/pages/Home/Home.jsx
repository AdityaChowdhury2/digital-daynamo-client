			...
			<section>
				...
				<div className="body-font relative">
					<div className="absolute inset-0 bg-base-100">
						...
						></iframe>
						<div className="bg-base-100 absolute bottom-20 left-40 flex flex-wrap py-6 rounded shadow-md">
					...
					<div className="container px-5 py-24 mx-auto flex">
						<div className="lg:w-1/3 md:w-1/2 bg-base-100 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10 shadow-md">
							...
							<div className="relative mb-4">
								...
								<input
									...
									id="email"
									name="email"
									className="w-full bg-base-100 rounded border border-base-300 focus:border-secondary focus:ring-2 focus:ring-secondary-content  outline-none  py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
								/>
							</div>
							<div className="relative mb-4">
								...
								<textarea
									id="message"
									name="message"
									className="w-full bg-base-100 rounded border border-base-300 focus:border-secondary focus:ring-2 focus:ring-secondary-content h-32  outline-none  py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"
								></textarea>
							</div>
							<button className=" bg-base-200 border-0 py-2 px-6 hover:bg-base-300 focus:outline-none  rounded text-lg">
								Button
							</button>
						</div>
					</div>
